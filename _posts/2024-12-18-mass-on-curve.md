...
=
-\frac{
\left(g + \dot{x}^2 \frac{d^2y}{dx^2}\right)
\left(\frac{dy}{dx} + \mu\,\mathrm{sgn}(\dot{x})\right)
}{
...
Nice! We now have a compact description of the particle motion for the more complex case where we have taken friction into account. If we plug in $\mu = 0$, we get back to the frictionless equation of motion given by \eqref{frictionless}, as we should. As in the frictionless case, \eqref{frictionEOM} is also independent of the particle's mass. 

<div class="row mt-3 justify-content-center">
    <div class="col-sm mt-3 mt-md-0 d-flex justify-content-center" style="max-width: 500px;">
        {% include figure.liquid loading="eager" path="assets/img/parabola_mu05.gif" class="rounded z-depth-1" style="width: 100%; height: auto;" %}
    </div>
</div>
