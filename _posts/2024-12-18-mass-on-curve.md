...
where \begin{equation} Q = -\frac{\partial D}{\partial \dot{x}},~ D = \frac{1}{N_v+1}\sum_{k} c_k |\vec{v\_k}|^{N_v+1} \end{equation}
...
<div style="border: 2px solid black; padding: 10px; width: fit-content; max-width: 100%; margin: 20px auto; text-align: center; box-sizing: border-box;">
\begin{equation} \frac{\mathrm{d}E}{\mathrm{d}t} = -\mu_k N|\vec{v}| \leq 0. \end{equation}
</div>
